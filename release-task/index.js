...
async function run() {
    ...
    const parapyCloudAddress = tl.getInput('parapyCloudAddress');
    const serviceAccountIdentifier = tl.getInput('serviceAccountIdentifier', true);
    const serviceAccountSecret = tl.getInput('serviceAccountSecret', true);
    const parapyAppId = tl.getInput('parapyAppId', true);
    const parapyAppVersion = tl.getInput('parapyAppVersion', true);
    const deploySerialized = tl.getInput('deploy', true);
